import mix from "../../../assets/pagesImages/mixImage.png"
...
export const Mix = () => {
    ...
    <div className="flex flex-col items-center w-full">
        <div className='mt-[3rem]'>
            <p className="text-[#BDBDBD] text-sm">Каталог · Готовые миксы · PADOVAN OVOMIX GOLD ROSSO</p>
            ...
            <div className="flex  w-full max-w-[1200px]">
                <div className="w-[50%]">
                    <img className="h-[50vh]" src={mix} alt="" />
                </div>

            <div className="w-[35%]">
                <h3 className='text-3xl font-bold mb-[1rem]'>PADOVAN OVOMIX GOLD ROSSO</h3>
                ...
                <span className="text-2xl font-bold">228 руб.</span>
                {/* количество */}
