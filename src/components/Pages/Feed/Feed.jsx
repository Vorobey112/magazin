...
export const Feed = () => {
    ...
    <div className="flex flex-col items-center w-full">
        <div className='mt-[3rem]'>
            <p className="text-[#BDBDBD] text-sm">Каталог · Аксессуары и другое · Избушка на курьих ножках</p>
            ...
            <div className="flex  w-full max-w-[1200px]">
                <div className="w-[50%]">
                    <img className="h-[50vh]" src={feed} alt="" />
                </div>

            <div className="w-[35%]">
                <h3 className='text-3xl font-bold mb-[1rem]'>Избушка на курьих ножках</h3>
